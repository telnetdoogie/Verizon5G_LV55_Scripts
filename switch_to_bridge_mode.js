...
$("#restart-modal .modal-body").html("<p>While your Device is restarting, its Wi-Fi network won't be available to the devices connected to it, and you won't be able to control your smart home devices. To access the Admin UI after the restart, try \'http://{public_ip+1 or public_ip-1}/cgi-bin/luci/verizon/system_settings\'</p>");
var msg = {
